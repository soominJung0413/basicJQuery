...
<script>
  ...
  <title></title>
    <style>
      ...
      #item3{
        z-index: -99;
        /* background-image: url(/images/slide/femailThink.jpg);  */
        position: absolute; 
        width: inherit;
        height:inherit;
        background-size: cover; 
      ...
      #item4{
        z-index: -99;
        /* background-image: url(/images/slide/sorting.jpg);  */
        position: absolute; 
        width: inherit;
        height:inherit;
        background-size: cover;  
  ...
  <body >
    ...
    <div style="width: 70%; height: 70%;
     margin-top: 5%; margin-left: auto; margin-right: auto; ">
	  	<div id="slider-div"  >
		    <div>
          <img id="item1" src="이미지1" >
        </img> 
          <p id="itemPara1" >
